...
const translations = {
  de: {    // Navigation
    ...
    'studio.saveDescription': 'Das Bild wird automatisch im Album <b>Generierte Bilder</b> gespeichert. Sie können es zusätzlich in einem weiteren Album speichern.',
  ...
  en: {    // Navigation
    ...
    'studio.saveDescription': 'The image is automatically saved to the <b>Generated Pictures</b> album. You can also save it to an additional album.',
